...
// import { useGetAllConversationofUserQuery } from "../../redux/features/conversation/conversationApi";
// import {
...
//   const socketId = useRef<Socket | null>(null);

//   const { isLoading, data: userConversationData } =
//     useGetAllConversationofUserQuery(user?._id, {});

//   const { data: getAllMessage, refetch } =
//     useGetAllMessageByConversationIdQuery(currentChat?._id, {
//       refetchOnMountOrArgChange: true,
//     });

//   const [
//     createNewMessage,
//     { isLoading: createLoading, isSuccess, error, data: createNewMessageData },
//   ] = useCreateNewMessageMutation();

//   useEffect(() => {
//     socketId.current = socketIO(ENDPOINT, { transports: ["websocket"] });

//     socketId.current.on("getMessage", (data: any) => {
//       setArrivalMessage({
...
//         //   }
//         // );
//         const response = await userConversationData();
...
//       socketId.current && socketId.current.emit("addUser", sellerId);
//       socketId.current &&
...
//         refetch();
//         setMessages(getAllMessage.messages);
//       } catch (error) {
//         console.log(error);
//       }
//     };
...
//     };
//     const receiverId =
//       currentChat && currentChat.members.find((member) => member !== user?._id);
...
//         setMessages([...messages, createNewMessageData?.message]);
//         updateLastMessage();
//       }
//     } catch (error) {
//       console.log(error);
...
// const SellerInbox: FC<SellerInboxProps> = ({
//   setOpen,
//   newMessage,
//   setNewMessage,
//   sendMessageHandler,
