...
const EditHero = () => {
  const { data, refetch } = useGetHeroLayoutQuery("Banner", {
  ...
  return (
    ...
    //     <div className="absolute top-[10px] lg:top-[50px] xl:h-[700px] xl:w-[700px] lg:h-[600px] lg:w-[600px] h-[50vh] w-[50vh] rounded-full">
    ...
    //         </div>
    //       </div>
    //       <div className="lg:w-[60%] flex flex-col mx-3 md:mt-0 !text-center lg:!text-left mt-[150px]">
    //         <textarea
    ...
    //           className={`${
    //             styles.button
    //           } !w-[100px] !h-[40px] !min-h-[40px] dark:text-white text-black bg-[#cccccc34]
    //                             ${
    ...
    <div className="w-full lg:flex items-center justify-center">
      <div className="absolute top-[60px] lg:h-[600px] lg:w-[600px] h-[50vh] w-[50vh] rounded-full">
        <div className="md:w-[90%] flex items-center justify-end pt-[70px] md:pt-0 z-10">
          <div className="relative flex items-center justify-end">
            <input
              type="file"
