...
interface IPaymentModal {
  ...
  handleSubmit: UseFormHandleSubmit<data, data>;
...
const PaymentModal = ({
  ...
  return (
    <div className="w-full h-screen z-[60] fixed top-0 left-0 flex items-center justify-center bg-[#0000004e]">
      <div
        ref={modalRef}
          ...
          <div>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <Input
                ...
                errors={errors}
                placeholder="Enter your Bank Name!"
                inputClassName={`${styles.input} mt-2`}
              />
              <Input
                label="Bank Country"
                type="text"
              ...
              <Input
                ...
                inputClassName={`${styles.input} !text-start mt-2`}
              />
              {/* <div className="pt-2">
                <label>
                ...
                <div className="800px:flex w-full items-center">
                  ...
                  <button
                    className={`${styles.button} !h-[42px] text-white ${
                      withdrawLoading && "cursor-not-allowed"
                    }`}
